...
class Weixin
{
    private $corpid = 'wx09e065809016c18c';
    private $corpsecret = 'R0wG72fJeOcK4nVMuw9MAJAsRALIHOwJqqRl8uJOpTfuhRWNzFqRvJ9DVAElocwm';
    ...
    public  $token_cache = '/tmp/token_cache';
    ...
    public function sendMsg($msg, $user) {
...
isset($_POST['user']) ? $user=$_POST['user'] : $user="@all";
$content=$_POST['content'];
$weixin = new Weixin;
return $weixin->sendMsg($content, $user);
